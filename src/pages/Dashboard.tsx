...
function Dashboard() {
  ...
  const [ordersCountPeriod, setOrdersCountPeriod] = useState<'today' | 'week' | 'month' | 'year'>('month');
                ...
                <div className="btn-group btn-group-sm dashboard-toggle-group" role="group">
                  {['today', 'week', 'month', 'year'].map((period) => (
                    <button
                      ...
                      onClick={() => setRevenuePeriod(period as 'today' | 'week' | 'month' | 'year')}
                    >
                ...
                <div className="btn-group btn-group-sm dashboard-toggle-group" role="group">
                  {['today', 'week', 'month', 'year'].map((period) => (
                    <button
                      ...
                      onClick={() => setOrdersCountPeriod(period as 'today' | 'week' | 'month' | 'year')}
                    >
                      {period.charAt(0).toUpperCase() + period.slice(1)}
                    </button>
                  ))}
