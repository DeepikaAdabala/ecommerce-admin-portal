function LineChart({ data, color = '#2563eb', label, params = [], xAxisLabel = 'X axis', yAxisLabel = 'Y axis', yAxisTicks = [] }) {
  const rawMaxValue = Math.max(...data.map((point) => point.value), 1);
